var RMresponse1 = "<h3>Professional RM Solution </h3><br>\
<ol>\
...
var RMresponse2 = "<h3>Professional RM Solution </h3><br>\
<ol>\
...
var responseString = "<h3>Your Response:</h3><br>"

function openCase(evt, caseNum) {
...
function showSims(numCase, id, ans) {
    ...
    document.getElementById(id).innerHTML = responseString + ans; // + termUseScore
}

function showSolution(caseNum) {
    ...
    switch (caseNum) {
        case 1:
            ...
            if (ans1 === "") {
                ...
                document.getElementById("solution1").innerHTML = RMresponse1;
                showSims(1, "analyze1", ans1)
            }
            break;
        case 2:
            ...
            if (ans2 === "") {
                ...
                document.getElementById("solution2").innerHTML = RMresponse2;
                showSims(2, "analyze2", ans2)
            }
            break;
    }
}